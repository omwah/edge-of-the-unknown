...
def _structure_brief(context: str) -> str:
    ...
    return (
        ...
        "specific match (a pinned `standing` counts double — how the species feels about the "
        "player outranks any one situational fact), so write the species' OWN distinctive voice "
        "here; a plain fallback already exists, so don't write a bland one.\n"
