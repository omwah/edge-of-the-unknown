...
# The four planet-surface-site kinds (ruins / artifact / ancient_tech / crashed_ship)
# retired GW-WP14: their presentation moved to the GroundWar expedition field-sketch
# art (`edge.groundwar.findart`, `edge.core.surface_finds`), which covers every
# surface DiscoveryKind now that `crashed_ship` has its own "hulk" find identity.
# Only the free-floating sector-space kinds remain here.
DISCOVERY_GRAMMAR = {
    "nebula": True,
    "black_hole": True,
    "wormhole": True,
