...
TUNING = SceneTuning(
    ...
    region_by_scale_class={
        ...
        "anchor": _REGION,
        "belt": _REGION,
        "stardock": Region(x_min=-3, x_max=3, y_min=-3, y_max=3, z_min=0, z_max=0),
    ...
    min_projected_cells_by_scale_class={
        ...
        "stardock": (2, 2), "orbital": (2, 2), "ship": (3, 1), "wreck": (2, 1),
    },
    ...
    min_visible_fraction_by_scale_class={
        ...
        "stardock": Fraction(1, 2), "orbital": Fraction(1, 2), "ship": Fraction(1, 2),
        "wreck": Fraction(1, 3),
    },
    cost_budget=1000,
